...
?>
    ...
    <!-- Google Code for dzi&#281;kujemy za zarezerwowanie miejsca! Conversion Page -->
    <script type="text/javascript">
        /* <![CDATA[ */
        var google_conversion_id = 1067661593;
        var google_conversion_language = "en";
        var google_conversion_format = "3";
        var google_conversion_color = "ffffff";
        var google_conversion_label = "i_JtCNPniXAQmfKM_QM";
    ...
    <noscript>
        <div style="display:inline;">
            <img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/1067661593/?label=i_JtCNPniXAQmfKM_QM&amp;guid=ON&amp;script=0"/>
        </div>
    </noscript>
